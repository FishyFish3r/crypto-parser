...
class SeleniumServerStub(object):
...
class SeleniumServerServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_SeleniumServerServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'selserv.SeleniumServer', rpc_method_handlers)
